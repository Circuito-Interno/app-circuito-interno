...
export default function App() {
  ...
  // Consulta de metadados em segundo plano de forma isolada
  useEffect(() => {
    let active = true;
    ...
    const fetchNowPlaying = async () => {
      try {
        ...
        // Ignora erros de metadados para não bloquear a reprodução
      }
    };
      ...
      try {
        ...
        for (const feed of RSS_FEEDS) {
          try {
            ...
            // Continua em caso de falha em feeds individuais
          }
        }
